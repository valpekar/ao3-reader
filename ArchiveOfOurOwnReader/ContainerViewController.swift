...
class ContainerViewController: UIViewController, CenterViewControllerDelegate, UIGestureRecognizerDelegate, SidePanelViewControllerDelegate {
    ...
    var viewControllers = ["FeedViewController", "FavoritesSiteController", "HistoryViewController", "FavoritesViewController", "MeViewController", "RecommendationsController", "SupportController"/*, "PublishWorkController"*/];
